 ...
 * 上传环形进度条
 */
public class WithWordsCircleProgressBar extends View {
    private static final String TAG = "WithWordsCircleProgressBar";
    ...
    public WithWordsCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
