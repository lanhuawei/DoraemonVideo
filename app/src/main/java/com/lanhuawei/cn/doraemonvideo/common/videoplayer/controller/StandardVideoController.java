package com.lanhuawei.cn.doraemonvideo.common.videoplayer.controller;
...
import com.lanhuawei.cn.doraemonvideo.common.videoplayer.util.BatteryReceiver;
import com.lanhuawei.cn.doraemonvideo.common.videoplayer.util.WindowUtil;
import com.lanhuawei.cn.doraemonvideo.common.videoplayer.widget.MarqueeTextView;
    ...
    public void setPlayState(int playState) {
        ...
        switch (playState) {
            ...
            case IjkVideoView.STATE_PLAYBACK_COMPLETED:
                LogUtil.e(TAG, "STATE_PLAYBACK_COMPLETED");
                hide();
                startPlayButton.setVisibility(GONE);
                ijkTitle.setVisibility(GONE);
                ijkControlSize.setVisibility(GONE);
