package com.lanhuawei.cn.doraemonvideo.common.customview;
...
import com.lanhuawei.cn.doraemonvideo.common.pulltorefresh.PtrUIHandler;
import com.lanhuawei.cn.doraemonvideo.common.pulltorefresh.indicator.PtrIndicator;
import com.lanhuawei.cn.doraemonvideo.common.pulltorefresh.indicator.PtrTensionIndicator;
...
public class DouYinPtrCustomHeader extends FrameLayout implements PtrUIHandler {
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.header_dou_yin_ptr_custom, this);
