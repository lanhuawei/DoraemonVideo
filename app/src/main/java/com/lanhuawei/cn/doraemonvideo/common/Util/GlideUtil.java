...
import com.lanhuawei.cn.doraemonvideo.common.customview.CircleTransform;
...
public class GlideUtil {
    ...
    public static Target<GlideDrawable> loadImageFormVideo(@NonNull String url, @NonNull ImageView imageView) {
        return getDrawableTypeRequest(imageView.getContext(), url)
                .override(DensityUtil.dip2px(MyApplication.getInstance(), 150), DensityUtil.dip2px(MyApplication.getInstance(), 150))
